...
const en = {
  ...
  achievements_for: 'Achievements (for {period})',
  // New clearer labels
  achievements_for_label: 'Achievements (for {label})',
...
const lv = {
  ...
  // New clearer labels
  achievements_for_label: 'Sasniegumi (par {label})',
  summary_showing: 'Rāda lapu {page} no {pages} — {total} ieraksti kopā par {label}.',
